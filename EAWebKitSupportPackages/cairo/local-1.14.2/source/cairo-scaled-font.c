 ...
 * array using cairo_glyph_cairo_free().  This may happen even if the provided
 ...
 * array using cairo_text_cluster_cairo_free().  This may happen even if the provided
 * array was large enough.
 *
 ...
 *                             clusters, num_clusters, cluster_flags);
 *
 *     cairo_glyph_cairo_free (glyphs);
 *     cairo_text_cluster_cairo_free (clusters);
 * }
