			   ...
			   CGImageRef            *image_out)
{
	...
	*image_out = CGImageRetain (surface->image);
    ...
    source_img = cairo_malloc (sizeof (quartz_source_image_t));
							 ...
							 CGPatternRef *cgpat)
{
    ...
    info = cairo_malloc (sizeof (SurfacePatternDrawInfo));
    if (unlikely (!info))
				       ...
				       unsigned int height)
{
    ...
    surface = cairo_malloc (sizeof (cairo_quartz_surface_t));
