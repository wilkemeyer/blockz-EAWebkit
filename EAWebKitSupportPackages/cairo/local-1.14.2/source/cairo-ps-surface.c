...
_cairo_ps_surface_get_page_media (cairo_ps_surface_t     *surface)
{
    ...
    page = cairo_malloc (sizeof (cairo_page_media_t));
					      ...
					      double		     height)
{
    ...
    surface = cairo_malloc (sizeof (cairo_ps_surface_t));
...
_string_array_stream_create (cairo_output_stream_t *output)
{
    ...
    stream = cairo_malloc (sizeof (string_array_stream_t));
