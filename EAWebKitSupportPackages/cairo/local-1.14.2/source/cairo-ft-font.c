...
_cairo_ft_unscaled_font_map_create (void)
{
    ...
    font_map = cairo_malloc (sizeof (cairo_ft_unscaled_font_map_t));
					 ...
					 cairo_ft_unscaled_font_t **out)
{
    ...
    unscaled = cairo_malloc (sizeof (cairo_ft_unscaled_font_t));
		       ...
		       cairo_image_surface_t	**surface)
{
	...
	bitmap.buffer = cairo_calloc (1, bitmap_size);
					...
					cairo_scaled_font_t       **font_out)
{
    ...
    scaled_font = cairo_malloc (sizeof (cairo_ft_scaled_font_t));
...
_cairo_ft_font_face_create_for_pattern (FcPattern *pattern)
{
    ...
    font_face = cairo_malloc (sizeof (cairo_ft_font_face_t));
