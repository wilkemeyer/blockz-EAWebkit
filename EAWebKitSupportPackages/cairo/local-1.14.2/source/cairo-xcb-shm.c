...
_cairo_xcb_shm_info_finalize (cairo_xcb_shm_info_t *shm_info)
{
    ...
    _cairo_mempool_cairo_free (&shm_info->pool->mem, shm_info->mem);
    _cairo_freepool_cairo_free (&connection->shm_info_freelist, shm_info);
					 ...
					 cairo_xcb_shm_info_t **shm_info_out)
{
    ...
    pool = cairo_malloc (sizeof (cairo_xcb_shm_mem_pool_t));
