...
{
	//+EAWebKitChange
	//11/7/2011 - Added && !defined(__SNC__) to _cairo_popcount.
#if (__GNUC__ > 3 || (__GNUC__ == 3 && __GNUC_MINOR__ >= 4)) && !defined(CS_UNDEFINED_STRING)
...
//+EAWebKitChange - Integrated from Cairo 1.10.2 to fix a shadow box matrix overflow bug. 
//6/26/2013
cairo_private void
_cairo_matrix_to_pixman_matrix (const cairo_matrix_t	*matrix,
				pixman_transform_t	*pixman_transform, double xc, double yc);
//-EAWebKitChange
